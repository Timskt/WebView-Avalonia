...
4. 支持 `win-x64`, `win-arm64`, `osx-x64`, `osx-arm64`, `linux-x64`,
   `linux-arm64`。
...
|---|---|---|---|---|
| CEF 134 默认线 | `134.3.9-codecs.1` | `134.6998.178-9n1m.1` | `3.134.178-codecs.1` | `net8.0` |
| CEF 106 Win7 线 | `106.0.26-codecs.1` | `106.5249.19-9n1m.1` | `3.120.11-cef106-codecs.1` | `net6.0` |
